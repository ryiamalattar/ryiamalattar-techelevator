...
public class Exercises {
	...
	public List<String> array2List(String[] stringArray) {
		...
		// pass us an array the we need to return list array
	...
	public List<String> reverseList(List<String> stringList) {
		...
		for (int i=0; i< stringList.size(); i++) {
			myStack.push(stringList.get(i));
		}
	
		for (int j=myStack.size();j > 0;j--) {
		
		reverseString.add(myStack.pop());
	}
		
		
		// interview question we can use stacks 
	...
	public List<String> fizzBuzzList(Integer[] integerArray) {
		...
		for (int i=0; i<integerArray.length; i++) {
			...
			if (integerArray[i] % 3 == 0 && integerArray[i] % 5 == 0) {
				...
				Integer numFromArray = new Integer (integerArray[i]);
			
				numList.add(numFromArray.toString());
...
//			     if (i % 2 == 0) {
//				results.add(listOne.get(j));
//				j++;
//				}
//			
//			   if (i % 2 == 1) {
//				results.add(listTwo.get(x));
//				x++;
//				}
//			}
//		//	else if ()
...
//		
//		
//		// after if for size if not equal we need to loop inside the shorter 
		return null;
	}
	...
	public List<Integer> boardingGate(List<Integer> seatNumberList) {
		...
		List<Integer> results = new ArrayList<Integer>();
		List<Integer> from1To10 = new ArrayList<Integer>();
		List<Integer> from11To20 = new ArrayList<Integer>();
		List<Integer> from21To30 = new ArrayList<Integer>();
		

		
		for (int i = 0; i<seatNumberList.size(); i++) {
			if (seatNumberList.get(i) > 0 && seatNumberList.get(i) < 31) {
				if (seatNumberList.get(i) > 0 && seatNumberList.get(i) < 11) {
					from1To10.add(seatNumberList.get(i));
				}
				else if (seatNumberList.get(i) > 10 && seatNumberList.get(i) < 21) {
					from11To20.add(seatNumberList.get(i));
				}
				else if (seatNumberList.get(i) > 20 && seatNumberList.get(i) < 31) {
					from21To30.add(seatNumberList.get(i));
				}
			}
		}
