...
select customer.first_name , customer.last_name , count(rental.rental_date) as count_rental
from customer
...
select customer.first_name , customer.last_name , sum(payment.amount) as sum_amount
from customer
...
select store.store_id , address.address , count(rental.rental_date) , sum(payment.amount) , avg(payment.amount) , staff.staff_id
from store
join address on store.address_id = address.address_id
join staff on store.store_id = staf


--select store.store_id , address.address , count(rental.rental_date) , sum(payment.amount) , avg(amount)
--from store
--join address on store.address_id = address.address_id
