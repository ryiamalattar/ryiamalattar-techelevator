 ...
 */
function isAdmitted(gpa , satScore=0,recommendation=0){
...
function useParameterToFilterArray(newArr){
    let unfilteredArray = [1, 2, 3, 4, 5, 6];
    return unfilteredArray.filter(newArr);
}
...
function addAll(...arguments){
    ...
    let result = arguments.reduce((sum , num) => {
            return sum + num;
        });
 ...
 * @returns {newArr[]} newarray of strings
 */
 ...
 */
    /**
     * @param {arr[]} arr takes an array of objects
     * @returns {newArr[]} returns new array of strings
     */
