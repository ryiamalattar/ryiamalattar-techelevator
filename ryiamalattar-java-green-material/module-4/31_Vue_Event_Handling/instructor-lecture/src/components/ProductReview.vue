...
<a href="#"  v-on:click.prevent="showForm = true" v-if="showForm === false">Show Review Form</a>
...
<form v-on:submit.prevent="addNewReview" v-if="showForm === true">
    ...
    <input type="button" value="Cancel" v-on:click.prevent="reset">
</form>
